...
static const char * player_agent_describe (agent_t * gthis)
{
...
static int player_agent_play (agent_t * gthis, const board_t * b,
...
static bool player_agent_destroy (agent_t * this)
{
